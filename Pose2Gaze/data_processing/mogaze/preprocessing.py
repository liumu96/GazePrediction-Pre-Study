...
# the original mogaze dataset Pose2Gaze/datasets/public 
dataset_path = "../../../../Pose2Gaze/datasets/public/mogaze/"
dataset_processed_path = "../../scratch/pose_forecast/mogaze_pose2gaze/"
data_idx = ["1_1", "1_2", "2_1", "4_1", "5_1", "6_1", "6_2", "7_1", "7_3"]
original_fps = 120.0
# downsample the original data to 30.0fps
downsample_rate = 4
# check the quality of eye gaze data
check_eye_gaze = True
# gaze confidence level >= 0.6 is considered as high-equality
